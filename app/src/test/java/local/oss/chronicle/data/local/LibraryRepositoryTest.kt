...
class LibraryRepositoryTest {
    ...
    @Test
    fun `addLibrary delegates to dao insert`() =
        runTest {
    ...
    @Test
    fun `addLibraries delegates to dao insertAll`() =
        runTest {
            val libraries =
                listOf(
    ...
    @Test
    fun `getLibraryById delegates to dao getById`() =
        runTest {
            val library = AccountTestFixtures.createPlexLibrary(accountId = "account-123")
    ...
    @Test
    fun `getAllLibraries delegates to dao getAllLibraries`() =
        runTest {
    ...
    @Test
    fun `getLibrariesForAccount delegates to dao getLibrariesForAccount`() =
        runTest {
    ...
    @Test
    fun `getLibrariesByServerId delegates to dao getLibrariesByServerId`() =
        runTest {
    ...
    @Test
    fun `updateLibrary delegates to dao update`() =
        runTest {
            val library = AccountTestFixtures.createPlexLibrary(accountId = "account-123")
    ...
    @Test
    fun `updateSyncTimestamp delegates to dao updateLastSyncedAt`() =
        runTest {
    ...
    @Test
    fun `updateItemCount delegates to dao updateItemCount`() =
        runTest {
            val libraryId = "library-123"
            val count = 42
    ...
    @Test
    fun `removeLibrary delegates to dao delete`() =
        runTest {
            val library = AccountTestFixtures.createPlexLibrary(accountId = "account-123")
    ...
    @Test
    fun `removeLibraryById delegates to dao deleteById`() =
        runTest {
            val libraryId = "library-123"
    ...
    @Test
    fun `getActiveLibrary delegates to dao getActiveLibrary`() =
        runTest {
            val library =
    ...
    @Test
    fun `getActiveLibraryFlow delegates to dao getActiveLibraryFlow`() =
        runTest {
    ...
    @Test
    fun `setActiveLibrary delegates to dao setActiveLibrary`() =
        runTest {
            val libraryId = "library-123"
    ...
    @Test
    fun `clearActiveLibrary delegates to dao deactivateAllLibraries`() =
        runTest {
