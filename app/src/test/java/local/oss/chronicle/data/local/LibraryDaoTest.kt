...
class LibraryDaoTest {
    ...
    @Test
    fun `insert library and retrieve by id`() = runTest {
    ...
    @Test
    fun `insert multiple libraries for same account`() = runTest {
        val account = AccountTestFixtures.createPlexAccount()
        accountDao.insert(account)
    ...
    @Test
    fun `update library modifies existing record`() = runTest {
        val account = AccountTestFixtures.createPlexAccount()
        accountDao.insert(account)
    ...
    @Test
    fun `delete library removes record`() = runTest {
        val account = AccountTestFixtures.createPlexAccount()
        accountDao.insert(account)
    ...
    @Test
    fun `library requires valid account foreign key`() = runTest {
    ...
    @Test
    fun `deleting account cascades to libraries`() = runTest {
        val account = AccountTestFixtures.createPlexAccount()
        accountDao.insert(account)
    ...
    @Test
    fun `get active library returns correct library`() = runTest {
        val account = AccountTestFixtures.createPlexAccount()
        accountDao.insert(account)

        val activeLib = AccountTestFixtures.createPlexLibrary(
            accountId = account.id,
            name = "Active",
            isActive = true
        )
        val inactiveLib = AccountTestFixtures.createPlexLibrary(
            accountId = account.id,
            name = "Inactive",
            isActive = false
        )
    ...
    @Test
    fun `only one library can be active at a time`() = runTest {
        val account = AccountTestFixtures.createPlexAccount()
        accountDao.insert(account)
    ...
    @Test
    fun `deactivate all libraries`() = runTest {
        val account = AccountTestFixtures.createPlexAccount()
        accountDao.insert(account)
    ...
    @Test
    fun `get all libraries returns all libraries across accounts`() = runTest {
    ...
    @Test
    fun `get libraries for account filters correctly`() = runTest {
        val account1 = AccountTestFixtures.createPlexAccount(displayName = "User 1")
        val account2 = AccountTestFixtures.createPlexAccount(displayName = "User 2")
    ...
    @Test
    fun `get libraries by server id`() = runTest {
        val account = AccountTestFixtures.createPlexAccount()
        accountDao.insert(account)
    ...
    @Test
    fun `update sync timestamp`() = runTest {
        val account = AccountTestFixtures.createPlexAccount()
        accountDao.insert(account)
    ...
    @Test
    fun `active library flow emits updates`() = runTest {
        val account = AccountTestFixtures.createPlexAccount()
        accountDao.insert(account)
