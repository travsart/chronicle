...
class LibraryScopedBookDaoTest {
    ...
    @Test
    fun `books with same plex id but different libraries are separate`() =
        runTest {
    ...
    @Test
    fun `getAllBooks for library excludes other libraries`() =
        runTest {
    ...
    @Test
    fun `search only searches within specified library`() =
        runTest {
            val lib1Book =
                createTestAudiobook(
                    id = "plex:1",
    ...
    @Test
    fun `favorites are library-specific`() =
        runTest {
            val lib1Book =
                createTestAudiobook(
                    id = "plex:1",
    ...
    @Test
    fun `recently listened scoped to library`() =
        runTest {
            val lib1Book =
                createTestAudiobook(
                    id = "plex:1",
    ...
    @Test
    fun `deleting books for library preserves other libraries`() =
        runTest {
