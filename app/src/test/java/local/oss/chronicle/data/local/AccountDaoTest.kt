...
class AccountDaoTest {
    ...
    @Test
    fun `insert account and retrieve by id`() =
        runTest {
    ...
    @Test
    fun `insert multiple accounts and retrieve all`() =
        runTest {
    ...
    @Test
    fun `update account modifies existing record`() =
        runTest {
    ...
    @Test
    fun `delete account removes record`() =
        runTest {
            val account = AccountTestFixtures.createPlexAccount()
            accountDao.insert(account)
    ...
    @Test
    fun `delete account by id removes record`() =
        runTest {
            val account = AccountTestFixtures.createPlexAccount()
            accountDao.insert(account)
    ...
    @Test
    fun `get accounts by provider type filters correctly`() =
        runTest {
    ...
    @Test
    fun `get account count returns correct number`() =
        runTest {
    ...
    @Test
    fun `accounts ordered by last used descending`() =
        runTest {
            val oldAccount =
                AccountTestFixtures.createPlexAccount(
                    displayName = "Old",
                    lastUsedAt = 1000L,
                )
            val newAccount =
    ...
    @Test
    fun `update last used timestamp`() =
        runTest {
    ...
    @Test
    fun `getAllAccounts flow emits updates`() =
        runTest {
            val account = AccountTestFixtures.createPlexAccount()
