...
class PlexSyncScrobbleWorkerTest {
    ...
    @Test
    fun `audiobook libraryId correctly identifies its library`() =
        runTest {
    ...
    @Test
    fun `library accountId correctly identifies owning account`() =
        runTest {
    ...
    @Test
    fun `library lookup respects audiobook libraryId over global config`() =
        runTest {
    ...
    @Test
    fun `multiple audiobooks from different libraries maintain correct context`() =
        runTest {
    ...
    @Test
    fun `library context chain is maintained from audiobook to account`() =
        runTest {
