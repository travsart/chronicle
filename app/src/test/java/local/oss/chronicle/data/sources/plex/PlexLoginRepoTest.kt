...
class PlexLoginRepoTest {
    ...
    @Test
    fun `checkForOAuthAccessToken does not corrupt PIN ID on network error`() = runTest {
    ...
    @Test
    fun `checkForOAuthAccessToken does not corrupt PIN ID on timeout`() = runTest {
        // Given: Valid PIN ID stored
        val originalPinId = 12345L
        plexPrefsRepo.oAuthTempId = originalPinId
    ...
    @Test
    fun `checkForOAuthAccessToken does not corrupt PIN ID on IOException`() = runTest {
        // Given: Valid PIN ID stored
        val originalPinId = 12345L
        plexPrefsRepo.oAuthTempId = originalPinId
    ...
    @Test
    fun `checkForOAuthAccessToken clears PIN ID on HTTP 404`() = runTest {
        // Given: Valid PIN ID stored
        val originalPinId = 12345L
        plexPrefsRepo.oAuthTempId = originalPinId
    ...
    @Test
    fun `checkForOAuthAccessToken succeeds and stores token on valid response`() = runTest {
        // Given: Valid PIN ID stored
        val originalPinId = 12345L
        plexPrefsRepo.oAuthTempId = originalPinId
