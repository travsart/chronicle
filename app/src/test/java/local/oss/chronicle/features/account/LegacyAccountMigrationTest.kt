...
class LegacyAccountMigrationTest {
    ...
    @Test
    fun migrate_skipsWhenAccountsAlreadyExist(): Unit =
        runBlocking {
            // Given
    ...
    @Test
    fun migrate_skipsWhenNoLegacyToken(): Unit =
        runBlocking {
            // Given
    ...
    @Test
    fun migrate_createsAccountFromLegacyData(): Unit =
        runBlocking {
            // Given
    ...
    @Test
    fun migrate_handlesNullUser(): Unit =
        runBlocking {
            // Given
            val legacyToken = "legacy-auth-token"
            val plexLibrary =
    ...
    @Test
    fun migrate_handlesNullLibrary(): Unit =
        runBlocking {
            // Given
            val legacyToken = "legacy-auth-token"
            val plexUser =
    ...
    @Test
    fun migrate_throwsExceptionOnFailure(): Unit =
        runBlocking {
            // Given
            whenever(accountRepository.hasAccounts()).thenReturn(false)
