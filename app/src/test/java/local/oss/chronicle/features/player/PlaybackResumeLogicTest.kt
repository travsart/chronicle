...
class PlaybackResumeLogicTest {
     ...
     */
    @Test
    fun `resume starts from last saved position`() =
        runTest {
     ...
     */
    @Test
    fun `position is preserved after pause`() =
        runTest {
     ...
     */
    @Test
    fun `multiple pause play cycles maintain correct position`() =
        runTest {
     ...
     */
    @Test
    fun `resume starts from correct track when position is in second track`() =
        runTest {
     ...
     */
    @Test
    fun `position state is correct when pausing for persistence`() =
        runTest {
     ...
     */
    @Test
    fun `position updates are correctly tracked during playback`() =
        runTest {
     ...
     */
    @Test
    fun `position updates correctly when crossing track boundary`() =
        runTest {
     ...
     */
    @Test
    fun `clear and reload allows resuming from saved position`() =
        runTest {
     ...
     */
    @Test
    fun `state transitions from EMPTY to PLAYING on initial play`() =
        runTest {
     ...
     */
    @Test
    fun `state transitions from PLAYING to PAUSED on pause`() =
        runTest {
     ...
     */
    @Test
    fun `state transitions from PAUSED to PLAYING on resume`() =
        runTest {
     ...
     */
    @Test
    fun `state clears to EMPTY when playback is stopped`() =
        runTest {
     ...
     */
    @Test
    fun `state is correctly reported during various playback stages`() =
        runTest {
     ...
     */
    @Test
    fun `position updates do not affect playing state`() =
        runTest {
            // Given: Audiobook is playing
            controller.loadAudiobook(
                audiobook = testAudiobook,
